...
| `Komplementaerfarben` | [Link](https://github.com/MDecker-MobileComputing/Android_Komplementaerfarben) | App to demonstrate [ViewModel](https://developer.android.com/reference/kotlin/androidx/lifecycle/ViewModel) |
...
| `Schimpfmeister` | [Link](https://github.com/MDecker-MobileComputing/Android_Schimpfmeister) | Android-port of [Schimpfolino](https://github.com/NikolaiRadke/Schimpfolino), demo for [ActionBar](https://developer.android.com/develop/ui/views/components/appbar); [Repo with variant for app store](https://github.com/MDecker-MobileComputing/Android_Schimpfmeister_AppStore) |
